...
import gdt.dmp.highmaps.client.labels.LegendLabelsFormatter;
...
public class Legend extends Configurable<Legend> {
     ...
     * in particular the {@link LegendLabelsFormatter#format(gdt.dmp.highmaps.client.labels.LegendLabelsData)}
     ...
     * {@link #setAlign(gdt.dmp.highmaps.client.Legend.Align)},
     * {@link #setVerticalAlign(gdt.dmp.highmaps.client.Legend.VerticalAlign)},
