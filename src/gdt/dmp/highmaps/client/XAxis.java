...
import gdt.dmp.highmaps.client.labels.XAxisLabels;
...
public class XAxis extends Axis<XAxis> {
     ...
     * <p/>
     *
     * @param redraw     Whether to redraw the axis or wait for an explicit call to {@link gdt.dmp.highmaps.client.BaseChart#redraw()}
     * @param categories An array of category names to use for the axis.
     * @return A reference to this {@link XAxis} instance for convenient method chaining.
     * @since 1.1.1
     */
