...
import gdt.dmp.highmaps.client.events.AxisSetExtremesEventHandler;
...
public abstract class Axis<T extends Axis> extends Configurable<T> {
     ...
     * found via the {@link gdt.dmp.highmaps.client.events.AxisSetExtremesEvent} instance
     * that is passed to the handler's {@link gdt.dmp.highmaps.client.events.AxisSetExtremesEventHandler#onSetExtremes(gdt.dmp.highmaps.client.events.AxisSetExtremesEvent)} method.
     *
     ...
     *
     * @param title Sets the title of axis, or null to hide the title.
     * @param redraw Whether to redraw the chart now or hold until the next {@link gdt.dmp.highmaps.client.BaseChart#redraw()}
     * @return A reference to this {@link Axis} instance for convenient method chaining.
     * @since 1.2.0
     */
