 ...
 * to zoom in and out on parts of the data as well as panning across the dataset. Applies only to {@link gdt.dmp.highmaps.client.StockChart}.
 *
...
public class Navigator extends Configurable<Navigator> {
    ...
    /**
     * Use the {@link gdt.dmp.highmaps.client.StockChart#getNavigator()} method to get access to the Navigator of the chart.
     *
