...
public class SeriesPlotOptions extends PlotOptions<SeriesPlotOptions> {
     ...
     * found via the {@link gdt.dmp.highmaps.client.events.SeriesClickEvent} instance
     * that is passed to the handler's {@link gdt.dmp.highmaps.client.events.SeriesClickEventHandler#onClick(gdt.dmp.highmaps.client.events.SeriesClickEvent)} method.
     *
     * @param seriesClickEventHandler The handler that should be invoked whenever a series click event occurs.
     * @return A reference to this {@link gdt.dmp.highmaps.client.BaseChart} instance for convenient method chaining.
     *
     * @since 1.1.0
     */
     ...
     * {@link gdt.dmp.highmaps.client.events.SeriesCheckboxClickEvent} instance
     * that is passed to the handler's
     * {@link gdt.dmp.highmaps.client.events.SeriesCheckboxClickEventHandler#onClick(gdt.dmp.highmaps.client.events.SeriesCheckboxClickEvent)}
     * method.
     *
