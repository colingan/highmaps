...
import gdt.dmp.highmaps.client.Color;
 ...
 * series in the chart (not just those of an area spline range type), then you can use the {@link gdt.dmp.highmaps.client.plotOptions.SeriesPlotOptions}
