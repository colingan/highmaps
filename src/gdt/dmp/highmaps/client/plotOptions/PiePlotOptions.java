...
import gdt.dmp.highmaps.client.events.PointLegendItemClickEventHandler;
import gdt.dmp.highmaps.client.labels.PieDataLabels;
...
public class PiePlotOptions extends PlotOptions<PiePlotOptions> {
     ...
     * found via the {@link gdt.dmp.highmaps.client.events.PointLegendItemClickEventHandler} instance
     * that is passed to the handler's {@link gdt.dmp.highmaps.client.events.PointLegendItemClickEventHandler#onClick(gdt.dmp.highmaps.client.events.PointLegendItemClickEvent)} method.
     *
