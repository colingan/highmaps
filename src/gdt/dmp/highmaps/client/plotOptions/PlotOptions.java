...
import gdt.dmp.highmaps.client.*;
import gdt.dmp.highmaps.client.labels.BaseDataLabels;
import gdt.dmp.highmaps.client.labels.DataLabels;
...
public abstract class PlotOptions<T extends PlotOptions> extends Configurable<T> {
     ...
     * control over the way the series display animations will occurs utils the {@link #setAnimation(gdt.dmp.highmaps.client.Animation)}
     * method instead.
     *
     ...
     * {@link gdt.dmp.highmaps.client.Chart#setColors(String...)} method.
     *
     ...
     * none were set.  Note that this method returns an {@link gdt.dmp.highmaps.client.labels.BaseDataLabels} and not simply
     * a {@link DataLabels} in order to handle alternative labels types such as
     * {@link gdt.dmp.highmaps.client.labels.PieDataLabels}.
     *
