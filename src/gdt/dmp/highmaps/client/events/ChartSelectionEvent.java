 ...
 * register it via the {@link gdt.dmp.highmaps.client.BaseChart#setSelectionEventHandler(ChartSelectionEventHandler)}
...
public class ChartSelectionEvent extends MouseEvent {
    ...
    public native double getXAxisMin(int axisIndex) /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.xAxis[axisIndex].min;
    }-*/;
    ...
    public native double getXAxisMax(int axisIndex) /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.xAxis[axisIndex].max;
    }-*/;
    ...
    public native double getYAxisMin(int axisIndex) /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.yAxis[axisIndex].min;
    }-*/;
    ...
    public native double getYAxisMax(int axisIndex) /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.yAxis[axisIndex].max;
    }-*/;
