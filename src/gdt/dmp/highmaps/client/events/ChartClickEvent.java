 ...
 * register it via the {@link gdt.dmp.highmaps.client.BaseChart#setClickEventHandler(ChartClickEventHandler)}
...
public class ChartClickEvent extends MouseEvent {
    ...
    public native double getXAxisValue(int axisIndex) /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.xAxis[axisIndex].value;
    }-*/;
    ...
    public native double getYAxisValue(int axisIndex) /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.yAxis[axisIndex].value;
    }-*/;
