 ...
 * {@link gdt.dmp.highmaps.client.plotOptions.SeriesPlotOptions#setSeriesLegendItemClickEventHandler(SeriesLegendItemClickEventHandler)}
...
public class SeriesLegendItemClickEvent extends SeriesEvent {
    ...
    public native boolean isVisible() /*-{
			return this.@gdt.dmp.highmaps.client.events.SeriesEvent::series.visible;
    }-*/;
