...
public abstract class PointEvent extends MouseEvent {
     ...
     * {@link gdt.dmp.highmaps.client.BaseChart#getSeries(String)} method.
     *
    ...
    public native String getSeriesId() /*-{
			return this.@gdt.dmp.highmaps.client.events.PointEvent::point.series.options.id;
    }-*/;
    ...
    public native String getSeriesName() /*-{
			return this.@gdt.dmp.highmaps.client.events.PointEvent::point.series.name;
    }-*/;
    ...
    public native String getPointName() /*-{
			return this.@gdt.dmp.highmaps.client.events.PointEvent::point.name;
    }-*/;
    ...
    public native double getXAsDouble() /*-{
			return this.@gdt.dmp.highmaps.client.events.PointEvent::point.x;
    }-*/;
    ...
    public native double getYAsDouble() /*-{
			return this.@gdt.dmp.highmaps.client.events.PointEvent::point.y;
    }-*/;
