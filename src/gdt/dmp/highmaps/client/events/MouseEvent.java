...
public abstract class MouseEvent {
    ...
    public native int getClientX() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.clientX || 0;
    }-*/;
    ...
    public native int getClientY() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.clientY || 0;
    }-*/;
    ...
    public native int getNativeButton() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.button || 0;
    }-*/;
    ...
    public native int getScreenX() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.screenX || 0;
    }-*/;
    ...
    public native int getScreenY() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.screenY || 0;
    }-*/;
    ...
    public native boolean isAltKeyDown() /*-{
			return !!this.@gdt.dmp.highmaps.client.events.MouseEvent::event.altKey;
    }-*/;
    ...
    public native boolean isControlKeyDown() /*-{
			return !!this.@gdt.dmp.highmaps.client.events.MouseEvent::event.ctrlKey;
    }-*/;
    ...
    public native boolean isMetaKeyDown() /*-{
			return !!this.@gdt.dmp.highmaps.client.events.MouseEvent::event.metaKey;
    }-*/;
    ...
    public native boolean isShiftKeyDown() /*-{
			return !!this.@gdt.dmp.highmaps.client.events.MouseEvent::event.shiftKey;
    }-*/;
