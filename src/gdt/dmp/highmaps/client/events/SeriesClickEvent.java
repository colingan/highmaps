 ...
 * register it via the {@link gdt.dmp.highmaps.client.plotOptions.SeriesPlotOptions#setSeriesClickEventHandler(SeriesClickEventHandler)}
...
public class SeriesClickEvent extends SeriesEvent {
    ...
    public native String getNearestPointName() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.point.name;
    }-*/;
    ...
    public native double getNearestXAsDouble() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.point.x;
    }-*/;
    ...
    public native double getNearestYAsDouble() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.point.y;
    }-*/;
    ...
    private native JavaScriptObject nativeGetPoint()  /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.point;
    }-*/;
