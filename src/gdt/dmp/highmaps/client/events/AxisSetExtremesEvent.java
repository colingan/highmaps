...
import gdt.dmp.highmaps.client.Axis;
...
public class AxisSetExtremesEvent extends AxisEvent {
     ...
     * events directly, but instead should register a {@link gdt.dmp.highmaps.client.events.AxisSetExtremesEventHandler}.
     *
    ...
    private native double getMinAsPrimitive() /*-{
			return this.@gdt.dmp.highmaps.client.events.AxisEvent::event.min;
    }-*/;
    ...
    private native double getMaxAsPrimitive() /*-{
			return this.@gdt.dmp.highmaps.client.events.AxisEvent::event.max;
    }-*/;
}
