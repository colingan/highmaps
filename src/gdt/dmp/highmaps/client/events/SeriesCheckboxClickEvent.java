 ...
 * register it via the
 * {@link gdt.dmp.highmaps.client.plotOptions.SeriesPlotOptions#setSeriesCheckboxClickEventHandler(SeriesCheckboxClickEventHandler)}
...
public class SeriesCheckboxClickEvent extends SeriesEvent {
    ...
    public native boolean isChecked() /*-{
			return this.@gdt.dmp.highmaps.client.events.MouseEvent::event.checked;
    }-*/;
