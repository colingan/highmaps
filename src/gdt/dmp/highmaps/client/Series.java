...
import gdt.dmp.highmaps.client.plotOptions.PlotOptions;
...
/**
 * Manages a data series (and its options) that can then be added to a {@link gdt.dmp.highmaps.client.Chart}.  As an extension
 * of {@link gdt.dmp.highmaps.client.Configurable} each series instance can also optionally have configuration options set on it.
 * In order to create a new series, utilize the {@link gdt.dmp.highmaps.client.Chart#createSeries()} method, configure it, add data
 * to it, and then add it to the chart via the {@link gdt.dmp.highmaps.client.Chart#addSeries(gdt.dmp.highmaps.client.Series)} method.  Note that a series
...
public class Series extends Configurable<Series> {
     ...
     * {@link gdt.dmp.highmaps.client.Series#setType(gdt.dmp.highmaps.client.Series.Type)} or {@link gdt.dmp.highmaps.client.Chart#setType(gdt.dmp.highmaps.client.Series.Type)}.
     */
    public enum Type {
    ...
    /**
     * Use the {@link gdt.dmp.highmaps.client.Chart#createSeries()} method to create new series instances.
     *
     ...
     * @return A reference to this {@link gdt.dmp.highmaps.client.Series} instance for convenient method chaining.
     */
     ...
     * </code></pre>
     * Note that if you don't set this explicitly the default series type is {@link gdt.dmp.highmaps.client.Series.Type#LINE}.
     *
     ...
     * options for all series in the chart (of each type) can be set on the {@link gdt.dmp.highmaps.client.Chart} instance,
     * and therefore you only need to use this method if you want to override the plot options for
     * this series only.
     * <p/>
     * Note that the general {@link gdt.dmp.highmaps.client.plotOptions.PlotOptions} type only represents the abstract base class of all the
     * different series types.  To call this method you need to instantiate one of the concrete
     * sub-classes instead (e.g. {@link gdt.dmp.highmaps.client.plotOptions.AreaPlotOptions},
     * {@link gdt.dmp.highmaps.client.plotOptions.BarPlotOptions}, etc.).
     * <p/>
     ...
     * the chart and then re-add it to the chart via the {@link gdt.dmp.highmaps.client.Chart#addSeries(gdt.dmp.highmaps.client.Series)} method.
     *
     ...
     *                  {@link gdt.dmp.highmaps.client.Chart#redraw()} is explicitly called
     ...
     *                  Note, see the {@link #addPoint(Number, boolean, boolean, gdt.dmp.highmaps.client.Animation)} method
     ...
     *                  a value over time.
     * @param animation Defaults to true. When true, the graph will be animated with default animation options.
     *                  Note, see the {@link #addPoint(Number, Number, boolean, boolean, gdt.dmp.highmaps.client.Animation)} method
     *                  for more control over how the animation will run.
     * @return A reference to this {@link gdt.dmp.highmaps.client.Series} instance for convenient method chaining.
     */
     ...
     *                  a value over time.
     * @param animation Defaults to true. When true, the graph will be animated with default animation options.
     *                  Note, see the {@link #addPoint(gdt.dmp.highmaps.client.Point, boolean, boolean, gdt.dmp.highmaps.client.Animation)} method
     *                  for more control over how the animation will run.
     * @return A reference to this {@link gdt.dmp.highmaps.client.Series} instance for convenient method chaining.
     */
     ...
     * {@link #setPoints(gdt.dmp.highmaps.client.Point[])} method instead.
     *
     ...
     * more control than just simply setting the y values of each data point, then use the
     * {@link #setPoints(gdt.dmp.highmaps.client.Point[], boolean)} method instead.
     *
     * @param yValues The array of Y values to set on the data series (replacing any data already in place)
     ...
     *                {@link gdt.dmp.highmaps.client.Chart#redraw()} after.
     * @return A reference to this {@link gdt.dmp.highmaps.client.Series} instance for convenient method chaining.
     */
     ...
     * use the {@link #setPoints(gdt.dmp.highmaps.client.Point[])} method instead.
     *
     ...
     * that have been set in persistent mode via the {@link gdt.dmp.highmaps.client.BaseChart#setPersistent(boolean)} method.
     * If you're using non-persistent charts, you can instead simply use the
     * {@link gdt.dmp.highmaps.client.Point#remove()} method to achieve the same affect.
     *
     ...
     * that have been set in persistent mode via the {@link gdt.dmp.highmaps.client.BaseChart#setPersistent(boolean)} method.
     * If you're using non-persistent charts, you can instead simply use the
     * {@link gdt.dmp.highmaps.client.Point#remove(boolean, boolean)} method to achieve the same affect.
     *
     * @param point     The point instance (obtained dynamically from the chart) to remove from the series.
     * @param redraw    Whether to redraw the chart after the point is removed. When removing more than one
     *                  point, it is highly recommended that the redraw option be set to false, and instead
     *                  {@link gdt.dmp.highmaps.client.Chart#redraw()} is explicitly called after the removing of points is finished.
     * @param animation Defaults to true. When true, the graph will be animated with default animation options.
     *                  Note, see the {@link #removePoint(gdt.dmp.highmaps.client.Point, boolean, gdt.dmp.highmaps.client.Animation)} method
     *                  for more control over how the animation will run.
     * @return A reference to this {@link gdt.dmp.highmaps.client.Series} instance for convenient method chaining.
     * @since 1.3.0
     */
     ...
     * that have been set in persistent mode via the {@link gdt.dmp.highmaps.client.BaseChart#setPersistent(boolean)} method.
     * If you're using non-persistent charts, you can instead simply use the
     * {@link gdt.dmp.highmaps.client.Point#remove(boolean, gdt.dmp.highmaps.client.Animation)} method to achieve the same affect.
     *
     * @param point     The point instance (obtained dynamically from the chart) to remove from the series.
     * @param redraw    Whether to redraw the chart after the point is removed. When removing more than one
     *                  point, it is highly recommended that the redraw option be set to false, and instead
    ...
    /**
     * Hides the series if visible. If the {@link gdt.dmp.highmaps.client.BaseChart#setIgnoreHiddenSeries(boolean)} option is true,
     ...
     * toggled and when selected, the series is returned in the {@link gdt.dmp.highmaps.client.BaseChart#getSelectedSeries()} method.
     *
