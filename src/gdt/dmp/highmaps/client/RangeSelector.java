...
/**
 * The range selector is a tool for selecting ranges to display within a {@link gdt.dmp.highmaps.client.StockChart}. It provides buttons to select
...
public class RangeSelector extends Configurable<RangeSelector> {
     ...
     * a {@link gdt.dmp.highmaps.client.StockChart}. For example, to create a button to display a 6 month time selection:
     * <pre><code>
     *    new RangeSelector.Button()
