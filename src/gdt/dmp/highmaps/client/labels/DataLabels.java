 ...
 * {@link gdt.dmp.highmaps.client.Chart#setSeriesPlotOptions(gdt.dmp.highmaps.client.plotOptions.SeriesPlotOptions)}
 * method), or to a specific data series (via the {@link gdt.dmp.highmaps.client.Series#setPlotOptions(PlotOptions)}
 * method).
 * <p/>
 * Example usage:
 * <code><pre>
