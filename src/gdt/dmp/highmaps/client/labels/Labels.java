...
import gdt.dmp.highmaps.client.Configurable;
import gdt.dmp.highmaps.client.Style;

/**
 * Represents the common base class for all label configuration option types, which allows
 * for general options to be set via the inherited {@link gdt.dmp.highmaps.client.Configurable#setOption(String, Object)}
 * method.  But also exposes type specific methods that the caller is encouraged to use instead,
 * such as {@link #setAlign(gdt.dmp.highmaps.client.labels.Labels.Align)}, {@link #setColor(String)}, etc.
 * <p/>
...
public abstract class Labels<T extends Labels> extends Configurable<T> {
     ...
     * like {@link gdt.dmp.highmaps.client.labels.Labels#setAlign(gdt.dmp.highmaps.client.labels.Labels.Align)} method.
     */
    public enum Align {
     ...
     * @return A reference to this {@link gdt.dmp.highmaps.client.labels.Labels} instance for convenient method chaining.
     */
