 ...
 * can then be passed to the {@link gdt.dmp.highmaps.client.XAxis#setLabels(gdt.dmp.highmaps.client.labels.XAxisLabels)}
...
public class XAxisLabels extends Labels<XAxisLabels> {
     ...
     * @return A reference to this {@link gdt.dmp.highmaps.client.labels.XAxisLabels} instance for convenient method chaining.
     */
