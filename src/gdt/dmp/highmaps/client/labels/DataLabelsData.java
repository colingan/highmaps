...
package gdt.dmp.highmaps.client.labels;

import gdt.dmp.highmaps.client.Point;
...
public class DataLabelsData {
    ...
    public native double getPercentage() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.percentage;
    }-*/;
    ...
    public native String getSeriesName() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.series.name;
    }-*/;
    ...
    public native String getPointName() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.point.name;
    }-*/;
    ...
    private native JavaScriptObject getNativePoint() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.point;
    }-*/;
    ...
    public native double getTotal() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.total;
    }-*/;
    ...
    public native boolean hasXValue() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.x != null;
    }-*/;
    ...
    public native double getXAsDouble() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.x;
    }-*/;
    ...
    public native boolean hasYValue() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.y != null;
    }-*/;
    ...
    public native double getYAsDouble() /*-{
			return this.@gdt.dmp.highmaps.client.labels.DataLabelsData::data.y;
    }-*/;
