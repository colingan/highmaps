...
/**
 * Represents the configuration options that can be set for the labels of a {@link gdt.dmp.highmaps.client.PlotBand}, and
 * can then be passed to the {@link gdt.dmp.highmaps.client.PlotBand#setLabel(PlotBandLabel)} method.  Example usage:
 * <code><pre>
...
public class PlotBandLabel extends Configurable<PlotBandLabel> {
     ...
     * @return A reference to this {@link gdt.dmp.highmaps.client.labels.PlotBandLabel} instance for convenient method chaining.
     */
