 ...
 * can then be passed to the {@link gdt.dmp.highmaps.client.YAxis#setLabels(gdt.dmp.highmaps.client.labels.YAxisLabels)}
...
public class YAxisLabels extends Labels<YAxisLabels> {
     ...
     * @return A reference to this {@link gdt.dmp.highmaps.client.labels.YAxisLabels} instance for convenient method chaining.
     */
