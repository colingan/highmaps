...
import gdt.dmp.highmaps.client.events.*;
import gdt.dmp.highmaps.client.labels.AxisLabelsData;
import gdt.dmp.highmaps.client.labels.DataLabelsData;
import gdt.dmp.highmaps.client.labels.LegendLabelsData;
import gdt.dmp.highmaps.client.labels.StackLabelsData;
import gdt.dmp.highmaps.client.plotOptions.*;
...
public abstract class BaseChart<T> extends Widget {
     ...
     * initial series animation, see {@link gdt.dmp.highmaps.client.plotOptions.PlotOptions#setAnimation(boolean)} method for
     ...
     * the chart by setting it to false here. It can be overridden for each individual API
     * method as a function parameter. The only animation not affected by this option is the
     * initial series animation, see {@link gdt.dmp.highmaps.client.plotOptions.PlotOptions#setAnimation(Animation)} method for
     * control over series animations that are added after the chart has been rendered.
     * <p/>
     ...
     * Note that the colors for each series can be overridden via the {@link gdt.dmp.highmaps.client.plotOptions.PlotOptions#setColor(String)} mechanism.
     * <p/>
     ...
     * {@link gdt.dmp.highmaps.client.plotOptions.Marker#setSymbol(gdt.dmp.highmaps.client.plotOptions.Marker.Symbol)} method
     * (which can be set on the series via its plot options, see
     * {@link Series#setPlotOptions(gdt.dmp.highmaps.client.plotOptions.PlotOptions)}).
     * <p/>
     ...
     * be overridden for each individual series via the {@link Series#setPlotOptions(gdt.dmp.highmaps.client.plotOptions.PlotOptions)} method.
     * <p/>
     * Note that changing the plot options on a chart that has already been rendered will only affect
     * series that are subsequently added to the chart (and will not impact any of the series that are already
     * rendered in the chart.)
     ...
     * {@link #setLinePlotOptions(gdt.dmp.highmaps.client.plotOptions.LinePlotOptions)},
     * {@link #setAreaPlotOptions(gdt.dmp.highmaps.client.plotOptions.AreaPlotOptions)}, etc.)
     * <p/>
     ...
     * Information where the user clicked can then be found through the {@link gdt.dmp.highmaps.client.events.ChartClickEvent} instance
     * that is passed to the handler's {@link gdt.dmp.highmaps.client.events.ChartClickEventHandler#onClick(gdt.dmp.highmaps.client.events.ChartClickEvent)} method.
     *
     ...
     * <br/><br/>
     * Some event methods (such as {@link gdt.dmp.highmaps.client.events.SeriesClickEvent#getSeriesId()})
